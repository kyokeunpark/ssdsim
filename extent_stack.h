...
class AbstractExtentStack {
  ...
  public:
    AbstractExtentStack() {}
    AbstractExtentStack(std::shared_ptr<StripeManager> s_m)
        : stripe_manager(s_m) {}
...
class ExtentStack : public AbstractExtentStack {
  ...
  public:
    ExtentStack(std::shared_ptr<StripeManager> s_m)
...
class WholeObjectExtentStack : public AbstractExtentStack {
  ...
  public:
    WholeObjectExtentStack(std::shared_ptr<StripeManager> stripe_manager)
