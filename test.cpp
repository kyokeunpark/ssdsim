...
TEST(StripeManagerTest, DeleteStripe) {
  ...
  s_m.create_new_stripe(5);
  s_m.create_new_stripe(10);
  stripe_ptr s = *s_m.stripes->begin();
  s_m.delete_stripe(s);
...
TEST(ExtentManagerTest, CreateNewExtent) {
  ...
  ext_ptr e1 = e_m.create_extent(5);
  ext_ptr e2 = e_m.create_extent(15, 2);
  ext_ptr e3 = e_m.create_extent();
...
TEST(ExtentManagerTest, DeleteExtent) {
  ExtentManager e_m = ExtentManager(100, nullptr);
  ext_ptr e1 = e_m.create_extent(5);
  ext_ptr e2 = e_m.create_extent(15);
  ext_ptr e3 = e_m.create_extent();
...
TEST(ExtentStack, AddExtentGetLengthOfExtentStack) {
  ...
  std::shared_ptr<StripeManager> s_m  = make_shared<StripeManager>(7, 2, 2, 2, 0.0);
    ...
    ext_ptr e1 = e_m.create_extent(5);
    ext_ptr e2 = e_m.create_extent(10);
    ext_ptr e3 = e_m.create_extent(15);
  e_s->add_extent(1,e1);
  e_s->add_extent(2,e2);
  e_s->add_extent(2,e3);
...
TEST(ExtentStack, GetExtentAtKey) {
  ...
  std::shared_ptr<StripeManager> s_m  = make_shared<StripeManager>(7, 2, 2, 2, 0.0);
    ...
    ext_ptr e2 = e_m.create_extent(10);
    ext_ptr e3 = e_m.create_extent(15);
    ext_ptr e4 = e_m.create_extent(12);
  e_s->add_extent(1,e1);
  e_s->add_extent(2,e2);
  e_s->add_extent(2,e3);
...
TEST(ExtentStack, BestEffortExtentStackGetExtAtClosestKey) {
  ...
  std::shared_ptr<StripeManager> s_m  = make_shared<StripeManager>(7, 2, 2, 2, 0.0);
    ...
    ext_ptr e3 = e_m.create_extent(15);
    ext_ptr e4 = e_m.create_extent(12);
    ext_ptr e5 = e_m.create_extent();
    ext_ptr e6 = e_m.create_extent();
  e_s->add_extent(1, e1);
  e_s->add_extent(1, e2);
  e_s->add_extent(2, e3);
  e_s->add_extent(2, e4);
...
TEST(ExtentStack, ExtentStackRandomizerPopStripeNumExts) {
  ...
  ext_ptr  shuffled_e1 = shuffled_res.front();
  ext_ptr  nonshuffled_e1 =  nonshuffled_res.front();
  ext_ptr  shuffled_e2 = shuffled_res.back();
  ext_ptr  nonshuffled_e2 =  nonshuffled_res.back();
...
TEST(ExtentStack, WholeObjectExtentStackNumStripes) {
  ...
  ext_ptr e5 = e_m.create_extent();
  ext_ptr e6 = e_m.create_extent();
  stack_val v1 = vector<ext_ptr >();
  v1.push_back(e1);
  v1.push_back(e2);
  stack_val v2 = vector<ext_ptr >();
  v1.push_back(e4);
  stack_val v3 = vector<ext_ptr >();
  v3.push_back(e5);
  v3.push_back(e6);
